...
public class CalculateAnsAcc : MonoBehaviour
{
    ...
    public StringEvent setAvgAnsAcc; //set average answer accuracy
    ...
    public void setAvgCalcAnsPPref() //set average calculated answer accuracy player pref
    {
    ...
    public void setCurrentIntArray() //sets currentQuestion array to the array from qClickedCount that's corresponding with the current question
    {
    ...
    public float calcAvgAnsAcc() //calculate the average answer accuracy of all questions
    {
        float sumAnsAcc = 0;
